  ...
  render() {
    return (
      <Container>
        ...
        <br />
        <Row>
          <Col xs={3} md={3} className="text-center my-auto"><Image src="./Collection-Images/2-1A-1.jpg" rounded style={{ width: "12em" }} /></Col>
          ...
          <Col xs={3} md={3} className="text-center my-auto"><Image src="./Collection-Images/2-1A-2.jpg" rounded style={{ width: "12em" }} /></Col>
        </Row>
        <br />
