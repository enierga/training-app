    ...
    render() {
        return(
            <Container>
                ...
                <br/>
                <Row>
                    <Col className="text-center my-auto"><Image src="./Disposal-Images/1B1.jpg" rounded style={{width:"8em"}}/></Col>
                    <Col className="text-center my-auto"><FontAwesomeIcon icon={faLongArrowAltRight} color={"#ea6360"} size="3x"/></Col>
                    <Col className="text-center my-auto"><Image src="./Disposal-Images/1B2.jpg" rounded style={{width:"10em"}}/></Col>
                    <Col className="text-center my-auto"><FontAwesomeIcon icon={faLongArrowAltRight} color={"#ea6360"} size="3x"/></Col>
                    <Col className="text-center my-auto"><Image src="./Disposal-Images/1B3.jpg" rounded style={{width:"9em"}}/></Col>
                    <Col className="text-center my-auto"><FontAwesomeIcon icon={faLongArrowAltRight} color={"#ea6360"} size="3x"/></Col>
                    <Col className="text-center my-auto"><Image src="./Disposal-Images/1B4.png" rounded style={{width:"8em"}}/></Col>
                </Row>
                <br/>
                <Row>
