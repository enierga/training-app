...
const itemsFromBackend = [
  ...
  { id: 'broken', content: "Pipette/Lab Tool Wrappers"},
];
...
const onDragEnd = (result, columns, setColumns) => {
  ...
  if (source.droppableId !== destination.droppableId) {
    ...
    if(destination.droppableId.toString() == "biowaste"){
      ...
      alert('Correct: This is for non-contaminated waste; wrappers are okay to go!')
      order = true;
                          ...
                          >
                            {(provided, snapshot) => {
                              return (
                                ...
                                >
                                  <Image src="./Types-Images/Wrap.jpg" rounded style={{width:"10em"}}></Image>
                                  {item.content}
                                </div>
                              );
                            }}
