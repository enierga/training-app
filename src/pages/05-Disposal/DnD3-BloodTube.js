...
const itemsFromBackend = [
  ...
  { id: 'broken', content: "Glass Blood Tubes" },
];
...
const columnsFromBackend = {
  ...
  glass: {
    name: "Glass",
    items: [],
    feedback: 'Incorrect: This is for contaminated broken glass only and does not include blood tubes.'
  },
  sharps: {
    name: "Sharps",
    items: [],
...
const onDragEnd = (result, columns, setColumns) => {
  ...
  if (source.droppableId !== destination.droppableId) {
    ...
    if (destination.droppableId.toString() === "sharps") {
      order = true;
                              ...
                              >
                                {(provided, snapshot) => {
                                  return (
                                    ...
                                    >
                                      <Image src="./Types-Images/BloodTube.jpg" rounded style={{ width: "7em" }}></Image>
                                      {item.content}
                                      <br/><br/>
