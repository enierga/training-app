...
const itemsFromBackend = [
  ...
  { id: 'broken', content: "Contaminated Bacterial, Media, and Culture Plates" },
];
    ...
    <div>
      ...
      <Container>
        <div style={{ textAlign: "center", }}>
          ...
          <p>Place the waste into the correct category to proceed.</p><br />
        </div>
      </Container>
                              ...
                              >
                                {(provided) => {
                                  return (
                                    ...
                                    >
                                      <Image src="./Types-Images/solids-petridish.jpg" rounded style={{ width: "10em" }}></Image>
                                      {item.content}
                                      <br /><br />
