...
const itemsFromBackend = [
  ...
  { id: 'broken', content: "Contaminated Serological Pipettes"},
];
...
const onDragEnd = (result, columns, setColumns) => {
  ...
  if (source.droppableId !== destination.droppableId) {
    ...
    if(destination.droppableId.toString() == "biowaste"){
      alert('Correct: They can go into the biowaste bin as long as theyre closed');
      order = true;
      ...
      alert('Correct: This is for contaminated serological pipettes')
      order = true
    }
                          ...
                          >
                            {(provided, snapshot) => {
                              return (
                                ...
                                >
                                  <Image src="./Types-Images/Serological.jpg" rounded style={{width:"10em"}}></Image>
                                  {item.content}
                                </div>
                              );
                            }}
